...
HD_PWD='C:/Users/Dilan/Finalproject/Finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source basys3_wrapper.tcl
