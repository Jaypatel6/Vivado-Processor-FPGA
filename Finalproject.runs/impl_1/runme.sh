...
HD_PWD='C:/Users/Dilan/Finalproject/Finalproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source basys3_wrapper.tcl -notrace
